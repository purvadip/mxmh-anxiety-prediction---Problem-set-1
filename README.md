...
The full pipeline covers **data cleaning → feature engineering → hyperparameter tuning → model evaluation → feature importance analysis**.
...
> **Best Model: XGBoost** — achieved the highest Average Precision (0.653) and ROC AUC (0.639), demonstrating superior generalization across all classification thresholds.
...
│
└── 📂 reports/
    └── technical_report.md        ← Full 1,500-word technical report
```
...
### Data Cleaning
- Removed outlier ages (outside 10–100 range)
- Clipped listening hours to 0–24h
- Median imputation for numeric features, mode for categorical
- Encoded binary and ordinal variables
- **Prevented data leakage** by excluding mental health score columns from features

### Models & Tuning
| Model | Tuning Method | Key Hyperparameters |
|:------|:------|:------|
| Logistic Regression | `LogisticRegressionCV` | C ∈ [0.001, 100], L2 penalty |
...
See the complete 1,500-word technical report in [`reports/technical_report.md`](reports/technical_report.md), covering:
- Data quality assessment & cleaning methodology
- Model development & hyperparameter tuning
- Detailed results analysis & precision-recall trade-offs
...
<p align="center">
  <em>Built with ❤️ for the Machine Learning Course Final Assessment</em>
</p>
